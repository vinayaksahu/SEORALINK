    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#040711] text-slate-900 dark:text-[#e2e8f0] flex items-center justify-center p-6 selection:bg-[#d4af37] selection:text-black relative">
      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center flex flex-col items-center space-y-2">
          ...
          <div className="flex items-center gap-1.5 text-xs font-bold text-red-500 dark:text-[#d4af37] uppercase tracking-widest pt-2">
        ...
        <div className="card-seoralink p-8 space-y-6 bg-white dark:bg-[#0d1424]/95 border-red-500/30 shadow-2xl">
          {error && (
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-[#0b1120] border border-red-500/30 text-slate-900 dark:text-white rounded-lg pl-10 pr-4 py-2.5 text-xs font-medium focus:outline-none focus:border-[#d4af37]"
                />
              </div>
            </div>
          ...
          <div className="text-center pt-2 border-t border-slate-200 dark:border-[#1e293b] text-xs text-slate-500 dark:text-[#64748b]">
