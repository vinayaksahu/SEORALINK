...
export function AdminMobileNav({ fullName }: AdminMobileNavProps) {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className={`fixed inset-y-0 left-0 w-72 max-w-[85vw] h-full h-screen h-[100dvh] bg-[#070a14] border-r border-red-500/30 z-[70] flex flex-col justify-between shadow-2xl transition-all duration-300 ease-in-out md:hidden ${
          isOpen
