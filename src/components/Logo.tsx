    ...
    <div className="flex items-center gap-3">
      <div style={{ width: size, height: size }} className="flex-shrink-0">
        <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          <polygon points="50,8 86,28 86,72 50,92 14,72 14,28" stroke="#d4af37" strokeWidth="4" fill="#0d1424" />
      ...
      {showText && (
        <div className="flex flex-col">
          ...
          <span className="text-[9px] font-bold text-[#38bdf8] uppercase tracking-wider mt-0.5">
